...
const Register = () => {
    ...
    const [country, countrychange] = useState("Indonesia");
                ...
                <form className="container" onSubmit={handlesubmit}>
                    <div className="card">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        ...
                                        <select value={country} onChange={e => countrychange(e.target.value)} className="form-control">
                                            ...
                                            <option value="asing">Luar Negeri</option>
                                        </select>
                                    </div>
                                </div>
                                <div className="col-lg-12">
                        ...
                        <div className="card-footer">
                            <button type="submit" className="btn btn-primary">Register</button><span className="mx-3">|</span>
